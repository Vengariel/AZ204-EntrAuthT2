...
namespace AZ204_EntrAuth.Clients
{
    public class PublicClient : BaseAppClient, IPublicClient
    {
        ...
        public override async Task Build_Process(ClientSettings clientSettings, string[] scopes, byte choosenOption)
        {
            ...
            await ProcessOptions(publicApp, scopes, choosenOption);
            //  Environment.Exit(0);
        }

        public async Task ProcessOptions(IPublicClientApplication publicApp, string[] scopes, byte choosenOption)
        {
